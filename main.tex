...
conversations at low marginal cost, suggesting a plausible path to scale.
...
Yet the rigor of evidence for AI as a dementia conversational intervention remains limited:
it is not established that an AI system can reliably reproduce the
I-CONECT interviewers' language behaviors, sustain engagement in older
adults (including those with MCI), or operate safely in real-world
settings. 
...
conversations \cite{hong2024aconect}. However, it was under-optimized for older
adults (e.g., limited modality/device adaptation, engagement and therapy implementation), and feasibility and
acceptability in the target population are unknown. Because deployment
with vulnerable older adults poses safety risks (e.g., misinformation,
biased or harmful content, privacy breaches, emotional distress),
rigorous development and evaluation are needed to determine whether
AI-based conversational intervention can be a scalable, safe, and
effective alternative to human-delivered programs.

\textbf{AI-CONECT translates I-CONECT to scalable, safety-aware delivery.}
...
\emph{Clinically}, it will provide novel methods for future behavioral interventions, preparing for next clinical trials using AI-based solutions.
...
\subsection{C.1 Intervention Approach.}
...
\subsection{C.2 Development Approach.}
...
\subsection{C.3 Approach for Feasibility Study.} 
