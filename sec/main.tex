...
Facing the challenge, conversational AI emerges with the potential to provide scalable, on-demand social engagement. 
Our recent preliminary study\cite{hong2024aconect} showed that Large Language Models (LLMs) can be customized to engage participants with MCI in simulated textual conversations. 
However, the system was still under-optimized for engaging older adults: (i) The single-modality conversation has limited interactivity and thereby low engagement compared to human-led ones; (ii) Older adults faces technical barriers to operate computers to use the AI; (iii) The safety of AI for older adults is unknown, which may lead to concerns in use.
Importantly, the feasibility of using AI among the targeted population is unknown. 
...
(iii) \textbf{Safety}: We will adopt real-time in-conversation guardrails to
...
empathy, and preferences in interaction modality.
