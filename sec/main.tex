...
We add safety assurance to define prohibited behaviors that should be avoided in conversations, for example, illegal content or financial advice. We also flag suicidal tendency using a protocol similar to the one used in the I-CONECT study.
...
Memory Division at Mass General Brigham (MGB, formally known as the Massachusetts General Hospital and Brigham Women's Hospital) and the Massachusetts Alzheimer's Disease Research Center (MADRC) (\textbf{see Dr. Gomez-Isla's letter of support}).
...
potential risks or any technical challenges in using AI.
