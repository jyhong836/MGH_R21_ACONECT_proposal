...
follow the I-CONECT protocol: execute semi-structured conversations, engage participants in reminiscence and vocabulary enhancement. (ii) \textbf{Usability}: To reduce the use
barrier for older adults, we will integrate real-time responsive voice interface with visual
...
\textbf{Aim 2: Conduct a feasibility and satisfaction survey among 40
...
will receive 4 sessions per week for 6 weeks, and each session
is a conversation with the chatbot for 15 minutes. A
staff member will do weekly 15-min check-in phone calls to check the
emotional status and potential risks emerging in completed sessions. We will collect both
...
rate (primary), the portion of participants who completed over 80\% of sessions,
and the engagement degree (secondary), the ratio of words spoken by the user. (ii)
...
emotional influence, opinions on the specific features of the chatbot, for
instance, the emotion responses, and speech fluency.
